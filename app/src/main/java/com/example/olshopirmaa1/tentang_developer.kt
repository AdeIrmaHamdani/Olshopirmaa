...
class tentang_developer : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tentang_developer)
        ...
        class tentang_developer : AppCompatActivity() {
            ...
            fun call(view: View) {
                ...
                dialIntent.data=Uri.parse("tel:" + "088291292604")
                ...
                bmp = BitmapFactory.decodeResource(resources, R.drawable.img_4)
